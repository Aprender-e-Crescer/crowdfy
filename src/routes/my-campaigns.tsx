...
export function LiveCampaigns() {
    ...
    <div className='font-[inter] m-5 py-2 px-3 border shadow-md shadow-gray-400 rounded-[12px] max-w-96'>
        ...
        <Button className='max-w-40 border-black ' variant={'shadow'}><img src={share} className='mx-2' />Share Campaign</Button>
    </div>
