      ...
      <div className="grid w-full gap-6 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[25rem]">
        ...
        <Card className="flex flex-col lg:max-w-md" x-chunk="charts-01-chunk-1">
          ...
          <CardContent className="flex flex-1 items-center">
            <ChartContainer config={{ resting: { label: "Resting", color: "hsl(var(--chart-1))" } }} className="w-full">
              <LineChart
                accessibilityLayer
              ...
              >
                ...
                <Line
                  ...
                  strokeWidth={2}
                  dot={false}
                  activeDot={{ fill: "var(--color-resting)", stroke: "var(--color-resting)", r: 4 }}
                />
                <ChartTooltip
                  content={
                    <ChartTooltipContent
        ...
        <Card className="max-w-xs" x-chunk="charts-01-chunk-2">
          ...
          <CardContent className="grid gap-4">
            ...
            <div className="grid auto-rows-min gap-2">
              ...
              <ChartContainer
                config={{ steps: { label: "Steps", color: "hsl(var(--muted))" } }}
                className="aspect-auto h-[32px] w-full"
              >
                <BarChart
                  accessibilityLayer
