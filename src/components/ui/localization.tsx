    ...
    <>
      <div className="hidden md:flex w-full">
        <div className="flex flex-col gap-y-5">
          ...
          <div className="flex justify-start py-2 grid grid-cols-2 gap-2 itens-center-start">
            <div>
          ...
          <div className=" grid grid-cols-3 gap-2 itens-center-start">
            <div className="text-xl">
              <p>Banner Image</p>
            </div>

            <div>
              <img className="w-[125px] h-[74px] " src={localimage} alt="" />
            </div>
