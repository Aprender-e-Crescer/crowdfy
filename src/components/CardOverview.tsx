  ...
  return (
    <div className="border-solid border-[#EAECF0] border-[2px] h-auto w-full lg:w-[936px] rounded-[12px] p-[20px]">
      ...
      <div className="flex flex-col lg:flex-row mb-[20px]">
        <div className="mb-[20px] lg:mr-auto">
          <Card titulo={<span>Renovate<br />Kingstown<br />Orphanage</span>} nomeCard={'ANA YAMAMOTO'} numeroId={'0xbb AC23 43af 98fg'} imagem={'https://www.brighthope.org/wp-content/uploads/2022/02/tim-trad-sS28i1H39AY-unsplash-800x533.jpg'} corFundo={"#BEF264"} corTexto={"#1E293B"} valorCard={"$2,840.40"} />
