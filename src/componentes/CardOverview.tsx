...
function CardOverview() {
  return (
    <div className="border-solid border-[#EAECF0] border-[2px] h-auto w-full lg:w-[1160px] rounded-[12px] p-[24px]">
      <div className="flex flex-col lg:flex-row justify-between">
        <h2 className="font-semibold text-[20px] mt-[28px] mb-[28px]">Your campaigns (2)</h2>
        <div className="flex justify-center lg:ml-[485px] mb-[28px]">
          <Button variant="BrancoBorda" className="mt-[20px] h-[40px] w-[70px] rounded-br-[0px] rounded-tr-[0px]">
            All
          </Button>
          <Button variant="AcinzentadoIcon" className="mt-[20px] h-[40px] w-[154px] rounded-br-[0px] rounded-tr-[0px] rounded-bl-[0px] rounded-tl-[0px]">
            <div>
              <PiTimer className="h-[20px]" />
            </div>
            <div className="ml-2">In Progress</div>
          </Button>
          <Button variant="AcinzentadoIcon" className="mt-[20px] h-[40px] w-[154px] rounded-bl-[0px] rounded-tl-[0px]">
            <LuCheckCheck />
      ...
      <div className="flex flex-col lg:flex-row mb-[20px] lg:ml-[0px]">
        <div className="mb-[20px] lg:mr-[24px] w-full lg:w-[calc(50%-12px)]">
      ...
      <div className="flex flex-col lg:flex-row mb-[20px] lg:ml-[0px]">
        ...
        <div className="mb-[20px] w-full lg:w-[calc(50%-12px)]">
          <Card Titulo={<span>Install Water<br />Well in<br />Kingstown</span>} Nome={'ANA YAMAMOTO'} NumeroId={'5226 6749 6789 4341'} Imagem={'https://th.bing.com/th/id/OIP.cKrnleA9Ut-H9geNg99UwgHaFj?pid=ImgDet&w=200&h=150&c=7'} CorFundo={"#BEF264"} CorTexto={"#1E293B"} ValorCard={"$1,260.20"} />
          <Progress value={30} className="mt-2" />
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row justify-between">
        <Button variant="letraVerde" className="mt-[12px] lg:mr-[24px]">
          Need help?
        </Button>
